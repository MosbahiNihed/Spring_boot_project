...
public class AuthRestAPIs {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
		...
		User user = new User(signUpRequest.getName(), signUpRequest.getUsername(), signUpRequest.getEmail(),
				encoder.encode(signUpRequest.getPassword()),signUpRequest.getNumero());
		...
		strRoles.forEach(role -> {
			...
			case "pm":
				...
				break;
				case "gerant":
					Role gerRole = roleRepository.findByName(RoleName.ROLE_GERANT)
							.orElseThrow(() -> new RuntimeException("Fail! -> Cause: Role Gerant not find."));
					roles.add(gerRole);
				...
				case "client":
					Role clientRole = roleRepository.findByName(RoleName.ROLE_CLIENT)
							.orElseThrow(() -> new RuntimeException("Fail! -> Cause: Role Client not find."));
